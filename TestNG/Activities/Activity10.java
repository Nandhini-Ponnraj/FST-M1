...
public class Activity10
    {
                    ...
                    for(Cell cell: row) {
                        if(cell != null) {
                            switch (cell.getCellType()) {
                                ...
                                case NUMERIC -> rowData.add((long)(cell.getNumericCellValue())+"");
        ...
        public static Object[][] signUpInfo() {
            String filePath = "C:/Users/003SVN744/IdeaProjects/Learning_TestNG/src/test/java/Activities/input/Activity10.xlsx";
        ...
        public void registrationTest(List<Object> rows) {
            ...
            //String phone= rows.get(4).toString().replace('.','0').replace('E','0').trim();
