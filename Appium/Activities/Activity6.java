...
public class Activity6 {
        ...
        public void chromeTest() {
            ...
            List<WebElement> imageElements = driver.findElements(AppiumBy.xpath("//android.widget.Image"));
            ...
            for(WebElement img:imageElements) {
                driver.findElement(AppiumBy.androidUIAutomator(UiScrollable + ".scrollTextIntoView(img)"));
            }
